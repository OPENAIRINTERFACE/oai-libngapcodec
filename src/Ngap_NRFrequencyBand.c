 ...
 */
static asn_oer_constraints_t asn_OER_type_Ngap_NRFrequencyBand_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_Ngap_NRFrequencyBand = {
	...
	sizeof(asn_DEF_Ngap_NRFrequencyBand_tags_1)
		/sizeof(asn_DEF_Ngap_NRFrequencyBand_tags_1[0]), /* 1 */
	{ &asn_OER_type_Ngap_NRFrequencyBand_constr_1, &asn_PER_type_Ngap_NRFrequencyBand_constr_1, Ngap_NRFrequencyBand_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
