...
asn_TYPE_member_t asn_MBR_Ngap_ScheduledCommunicationTime_1[] = {
	{ ATF_POINTER, 4, offsetof(struct Ngap_ScheduledCommunicationTime, dayofWeek),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_Ngap_dayofWeek_constr_2, &asn_PER_memb_Ngap_dayofWeek_constr_2,  memb_Ngap_dayofWeek_constraint_1 },
	...
	{ ATF_POINTER, 3, offsetof(struct Ngap_ScheduledCommunicationTime, timeofDayStart),
		...
		0,
		{ &asn_OER_memb_Ngap_timeofDayStart_constr_3, &asn_PER_memb_Ngap_timeofDayStart_constr_3,  memb_Ngap_timeofDayStart_constraint_1 },
		0, 0, /* No default value */
		"timeofDayStart"
		},
	{ ATF_POINTER, 2, offsetof(struct Ngap_ScheduledCommunicationTime, timeofDayEnd),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_Ngap_timeofDayEnd_constr_4, &asn_PER_memb_Ngap_timeofDayEnd_constr_4,  memb_Ngap_timeofDayEnd_constraint_1 },
		0, 0, /* No default value */
		"timeofDayEnd"
		},
	{ ATF_POINTER, 1, offsetof(struct Ngap_ScheduledCommunicationTime, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Ngap_ProtocolExtensionContainer_175P225,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
