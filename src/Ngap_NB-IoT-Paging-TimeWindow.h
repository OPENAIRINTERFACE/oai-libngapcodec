...
ber_type_decoder_f NB_IoT_Paging_TimeWindow_decode_ber;
der_type_encoder_f NB_IoT_Paging_TimeWindow_encode_der;
xer_type_decoder_f NB_IoT_Paging_TimeWindow_decode_xer;
xer_type_encoder_f NB_IoT_Paging_TimeWindow_encode_xer;
oer_type_decoder_f NB_IoT_Paging_TimeWindow_decode_oer;
oer_type_encoder_f NB_IoT_Paging_TimeWindow_encode_oer;
