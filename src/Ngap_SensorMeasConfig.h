...
ber_type_decoder_f SensorMeasConfig_decode_ber;
der_type_encoder_f SensorMeasConfig_encode_der;
xer_type_decoder_f SensorMeasConfig_decode_xer;
xer_type_encoder_f SensorMeasConfig_encode_xer;
oer_type_decoder_f SensorMeasConfig_decode_oer;
oer_type_encoder_f SensorMeasConfig_encode_oer;
