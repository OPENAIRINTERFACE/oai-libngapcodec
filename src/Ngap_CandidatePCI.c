...
asn_TYPE_member_t asn_MBR_Ngap_CandidatePCI_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_CandidatePCI, candidatePCI),
		...
		0,
		{ &asn_OER_memb_Ngap_candidatePCI_constr_2, &asn_PER_memb_Ngap_candidatePCI_constr_2,  memb_Ngap_candidatePCI_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_CandidatePCI, candidateNRARFCN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_Ngap_candidateNRARFCN_constr_3, &asn_PER_memb_Ngap_candidateNRARFCN_constr_3,  memb_Ngap_candidateNRARFCN_constraint_1 },
		0, 0, /* No default value */
		"candidateNRARFCN"
		},
