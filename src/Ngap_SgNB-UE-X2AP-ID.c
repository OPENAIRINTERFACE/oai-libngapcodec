 ...
 */
static asn_oer_constraints_t asn_OER_type_Ngap_SgNB_UE_X2AP_ID_constr_1 CC_NOTUSED = {
	{ 4, 1 }	/* (0..4294967295) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_Ngap_SgNB_UE_X2AP_ID = {
	...
	sizeof(asn_DEF_Ngap_SgNB_UE_X2AP_ID_tags_1)
		/sizeof(asn_DEF_Ngap_SgNB_UE_X2AP_ID_tags_1[0]), /* 1 */
	{ &asn_OER_type_Ngap_SgNB_UE_X2AP_ID_constr_1, &asn_PER_type_Ngap_SgNB_UE_X2AP_ID_constr_1, Ngap_SgNB_UE_X2AP_ID_constraint },
	0, 0,	/* No members */
